...
RUN apt-get update && \
    ...
    pip3 install -r $REF/requirements.txt --break-system-packages
...
ADD https://ci.jenkins.io/job/Plugins/job/bitbucket-push-and-pull-request-plugin/job/PR-389/1/artifact/target/bitbucket-push-and-pull-request.hpi $REF/plugins/bitbucket-push-and-pull-request.jpi
